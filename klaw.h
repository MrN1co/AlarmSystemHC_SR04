...
#include "MKL05Z4.h"
#define S1	/*B*/6						// Numer bitu dla klawisza S1
#define S2	/*A*/7						// Numer bitu dla klawisza S2
#define S3	/*A*/11						// Numer bitu dla klawisza S3
#define S4	/*A*/12						// Numer bitu dla klawisza S4
